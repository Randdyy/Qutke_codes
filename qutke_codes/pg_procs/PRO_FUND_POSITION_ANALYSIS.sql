create or replace function PRO_FUND_POSITION_ANALYSIS
(
...
*/
    ...
    /* 插入 量化基金分析   FUND_QUANT_ANALYSIS  */
        ...
        PRO_FUND_QUANT_ANALYSIS(o_code, o_note, i_f_code, i_biz_date);
        commit;
    ...
    IF(length(i_f_code)>20) THEN
        ...
        PRO_FUND_VAR(o_code, o_note, i_f_code, i_biz_date);
        commit;
...
end PRO_FUND_POSITION_ANALYSIS;
